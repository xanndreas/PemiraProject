...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-candidateCategories">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($categories as $key => $category)
                        <tr data-entry-id="{{ $category->id }}">
                            ...
                            <td>
                                @foreach($category->candidates as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-candidateCategories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
