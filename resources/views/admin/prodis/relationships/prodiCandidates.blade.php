...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-prodiCandidates">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.candidate.fields.prodi') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-prodiCandidates:not(.ajaxTable)').DataTable({ buttons: dtButtons })
