...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-jurusanCandidates">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($candidates as $key => $candidate)
                        <tr data-entry-id="{{ $candidate->id }}">
                            ...
                            <td>
                                {{ App\Candidate::SEBAGAI_SELECT[$candidate->sebagai] ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-jurusanCandidates:not(.ajaxTable)').DataTable({ buttons: dtButtons })
