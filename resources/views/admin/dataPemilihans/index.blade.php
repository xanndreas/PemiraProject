...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-DataPemilihan">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.data-pemilihans.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'user_name', name: 'user.name' },
{ data: 'user.nim', name: 'user.nim' },
{ data: 'user.kelas', name: 'user.kelas' },
{ data: 'candidate_name', name: 'candidate.name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-DataPemilihan').DataTable(dtOverrideGlobals);
