...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tahapan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tahapans.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jenis_tahapan') ? 'is-invalid' : '' }}" type="text" name="jenis_tahapan" id="jenis_tahapan" value="{{ old('jenis_tahapan', '') }}">
